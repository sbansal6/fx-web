...
describe('processor.service',function(){
    ...
    describe('getNodePropertyById',function(){

        it('test1',function(){
            console.log(processorService.getNodePropertyById(toolData,'Google_7a55048e-d0a3-cf3e-59b1-e2ff2974ff7e'))
        })
    })
    ...
    describe('getFieldMappings',function(){
        ...
        it('test1',function(){
            console.log(processorService.getFieldMappings(toolData,'field1'))
        })
